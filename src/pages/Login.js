...
// function Login() {
//   const KakaoAuthUrl = `https://kauth.kakao.com/oauth/authorize?client_id=45285e0960a657197d7e58601b2e8c97&redirect_uri=http://localhost:3000/api/kakao&response_type=code`;
//   const handleLogin = () => {
//     window.location.href = KakaoAuthUrl;
//   };

//   //인가 코드값 추출
//   // const query = new URL(window.location.href).searchParams.get("code");
//   // console.log(query);
